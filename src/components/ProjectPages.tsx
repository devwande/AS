      ...
      <div className="relative hidden lg:block ">
        <div className="">
          <img
            ...
            alt={alt}
            className={"w-full h-[calc(100vh-135px)] max-h-[800px] object-cover brightness-75"}
            loading="eager"
            decoding="async"
          />
        </div>
        ...
        <motion.div
          ...
          className="absolute inset-1 flex flex-col justify-center md:pl-8 lg:pl-32 lg:w-[700px] space-y-6"
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="button mt-10 font-primary max-w-[300px]"
          >
