  ...
  return (
    <motion.main initial="hidden" animate="visible" exit="hidden" className={"max-w-[1440px] w-full mx-auto relative"}>
      ...
      <main className="max-w-[570px] mx-auto md:max-w-full xl:max-w-[1440px] space-y-20 md:px-24">
        <motion.section className="font-primary">
          ...
          <div className="h-[calc(100vh-98px)] md:h-[calc(100vh-135px)] max-h-[800px] relative">
            <motion.img
              ...
              src={Paramour}
              alt="Paramour"
              className="absolute mx-auto inset-0 h-full max-h-[800px] w-full object-cover brightness-75 lg:hidden"
              loading="eager"
              data-aos={"fade-up"}
            />
            <motion.div
              ...
              className="absolute inset-0 flex flex-col items-start justify-center space-y-6 pl-7 sm:pl-12 ls:pl-20 lg:hidden transition-all duration-300"
            >
              <h1 className="text-white text-[clamp(3rem,9.14vw+1rem,5rem)] leading-[clamp(3.25rem,10.3vw+1.2rem,4.3rem)] max-w-[400px] ">
                Project <br /> Paramour
              </h1>
              ...
              <motion.button
                ...
                className="button px-12 mt-20 font-primary"
              >
                See Our Portfolio {""}
                <ArrowRight />
              </motion.button>
        ...
        <div>
          <hr className="w-1/3 container-in sm:mx-0 hidden" />
        </div>
        ...
        <motion.section
          ...
          initial="hidden"
          animate="visible"
          className="relative container-body max-w-[570px] md:max-w-[1440px] mx-auto font-primary my-[76px] md:my-[120px] lg:my-[145px] xl:my-[190px] px-6 text-dark-gray sm:px-1 grid ld:grid-cols-[1fr_350px] ld:gap-20 xl:gap-32 transition-all duration-300"
        >
          <div className="">
            <p className="absolute font-bold tracking-[-0.125rem] leading-[-8.5rem] text-[clamp(8.5rem,15.5vw+1rem,16rem)] text-light-gray opacity-50 hidden md:block -top-[6rem] ls:-top-[7.5rem] lg:-top-[10rem] xl:-top-[12.5rem] z-30">
              Welcome
            </p>
            <div className="border-[0.5px] border-dark-gray opacity-70 w-[65px] absolute left-[1.5rem] md:hidden"></div>
            <div className="ld:ml-auto ld:min-w-[500px] max-w-[572px] ls:max-w-[700px] lg:max-w-[445px]">
              <h2 className="text-[clamp(3rem,9.14vw+1rem,4.2rem)] leading-[clamp(3.25rem,10.3vw+1.2rem,4.3rem)] font-[800] tracking-[0.075rem] whitespace-nowrap pb-8 pt-[4.125rem]">
        ...
        <div className={"flex justify-between pt-16"}>
          <motion.h1
            variants={fadeIn}
            className="container-in sm:mx-0 text-md md:tracking-wide md:font-bold font-primary"
          >
            Featured
          </motion.h1>
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={() => navigate("/portfolio")}
            className={"button px-10 hidden sm:flex"}
          >
            See All {""}
            <ArrowRight />
          </motion.button>
        ...
        >
          {projects.map((project) => (
            <motion.div variants={fadeIn} key={project.id} className="relative">
