...
const Home = () => {
    ...
    return (
        <>
            ...
            <Navbar />
            <main className="max-w-[1440px] space-y-20 md:px-24">
                <div className="relative font-primary">
                    ...
                    <div className="h-[calc(100vh-82px)] relative">
                        ...
                        <div className="absolute inset-0 flex flex-col items-start justify-center space-y-6 pl-7">
                            <h1 className="text-white text-md">Project Paramour</h1>
                ...
                <div className="relative space-y-10 h-screen font-primary">
                    ...
                    <div className="absolute inset-0 flex flex-col items-start justify-center text-start container-in mx-20 space-y-20">
                ...
                <div className={"flex justify-between"}>
                    <h1 className="container-in md:mx-0 text-md md:tracking-wide md:font-bold font-primary">Featured</h1>
                    <button className={"button"}>See All <ArrowRight /></button>
                </div>

                <div className="space-y-4 container-body md:mx-0 font-primary">
                        ...
                        <div key={project.id} className="relative">
                            <div className="relative h-64 w-full">
                                ...
                                <div className={"absolute inset-0 flex justify-between"}>
                                    ...
                                    <div className={"flex items-end p-3 text-light-gray text-[250px] leading-[200px] font-bold font-primary"}><h1>{project.id}</h1></div>
                                </div>
                            </div>
                        </div>
                    ))}
                    <button className="button font-primary w-full flex justify-center md:hidden">
                        See All
